...
const userExperienceSchema = new mongoose.Schema({
	/** General Tripper Preferences */
	travelFrequency: {type: String, enum: [
	...
	passports: [String],
	visas: [String],
	connectivityNeeds: {type: String, enum: [
	...
	climateAndWeather: [String],
	culture: [String],
	language: {type: String, enum: ['Comfortable with different languages', 'Prefer English-speaking countries', '', null]},
	healthAndAccessibility: String,
	safety: String,
	/** Travel Style and Budget */
	travelStyle: [String],
	tripDuration: String,
	transportPreferences: [String],
	accommodationBudget: {type: {low:Number, high:Number}, default: {low:0, high:1000}},
	diningBudget: {type: {low:Number, high:Number}, default: {low:0, high:1000}},
	activitiesBudget: {type: {low:Number, high:Number}, default: {low:0, high:1000}},
	/** ToS */
