...
const ProfileCard = ({ name, pictureLink, roles, websiteLink, linkedInLink }) => {
  ...
  if (pictureLink === undefined || pictureLink === null || pictureLink === "") {
    pictureLink = "/project-04_trekkers/img/Trekkers_Light_Logo.svg";
  }
    ...
    <div className={styles.profileAreaContainer}>
      ...
      <div className={styles.trekkersCard}>
        <div className={styles.trekkersSlides}>
          <img src='/project-04_trekkers/img/Trekkers_About.jpeg' />
        </div>
      ...
      <div className={styles.aboutCard}>
        <div className={styles.trekkersLogoContainer}>
          <img src="/project-04_trekkers/img/mission.svg" alt="trekkers Capital Savings Logo" className={styles.trekkersLogo} />
        </div>
        <div className={styles.aboutDescriptionContainer}>
      ...
      <div className={styles.aboutCard}>
        <div className={styles.trekkersLogoContainer}>
          <img src="/project-04_trekkers/img/vision.svg" alt="trekkers Capital Savings Logo" className={styles.trekkersLogo} />
        </div>
        <div className={styles.aboutDescriptionContainer}>
      ...
      <div className={styles.aboutCard}>
        <div className={styles.trekkersLogoContainer}>
          <img src="/project-04_trekkers/img/values.svg" alt="trekkers Capital Savings Logo" className={styles.trekkersLogo} />
        </div>
        <div className={styles.aboutDescriptionContainer}>
