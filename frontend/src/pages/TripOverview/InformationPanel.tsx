        ...
        <>
            ...
            <Timeline bulletSize={24} lineWidth={2} className={classes.timeline}>
                <Timeline.Item bullet={<IconMapPin size={12} />} lineVariant="dashed">
                    <Text c="dimmed" size="sm">Capilano Suspension Bridge - a simple suspension bridge crossing the Capilano River in Upper Capilano, BC</Text>
                </Timeline.Item>

                <Timeline.Item bullet={<IconMapPin size={12} />} lineVariant="dashed">
                    <Text c="dimmed" size="sm">Lake Louise - a glacial lake within Banff National Park in Alberta, Canada</Text>
                </Timeline.Item>

                <Timeline.Item bullet={<IconMapPin size={12} />} lineVariant="dashed">
                    <Text c="dimmed" size="sm">Banff - a resort town in the province of Alberta, located within Banff National Park</Text>
                </Timeline.Item>
            </Timeline>
        </>
    );
